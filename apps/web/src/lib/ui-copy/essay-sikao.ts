...
export const ESSAY_SIKAO_COPY = {
  ...
  submitAnswerRequired:   '请先写下答案再提交',
  submitRetry:            '提交失败,请稍后再试',
  topbarExitExam:         '退出申论考场',
  topbarContinueExam:     '继续作答',
  topbarConfirmExit:      '确认退出',
  topbarExitTitle:        '退出本次申论作答？',
  topbarExitDescription:  '当前草稿会按自动保存节奏保留，离开后可从同一套卷继续。',
  topbarViewMaterials:    '查看材料',
  topbarReturnAnswer:     '回到答题',
  topbarPauseExam:        '暂停作答',
  topbarFontSize:         '调整答题字号',
  topbarDraftPaper:       '打开草稿纸',
  topbarMarkQuestion:     '标记本题',
  topbarHelp:             '查看帮助',
  topbarFullscreen:       '切换全屏',
  topbarSubmitShort:      '交卷',
  topbarSubmitting:       '提交中…',
  topbarTimerLabel:       '倒计时',
  topbarTotalChars:       '全卷字数',
  helpTitle:              '申论作答提示',
  helpDescription:        '左侧阅读材料并标注重点，右侧在田字格中作答；草稿纸可记录提纲。',
  helpClose:              '知道了',
  draftTitle:             '草稿纸',
  draftDescription:       '草稿内容会进入现有自动保存快照，手写与 OCR 不在本入口启用。',
  draftPlaceholder:       '在这里写提纲、分论点或例子…',
  draftClose:             '收起草稿纸',
  draftWriteMode:         '文字',
  draftDrawMode:          '手绘',
  draftClear:             '清空',
  draftDrawArea:          '草稿纸手绘区',
  draftFooterHint:        '草稿不计入答卷',
  materialTabs:           '材料切换',
  materialToolbar:        '材料标注工具',
  materialUnderline:      '划线',
  materialHighlight:      '高亮',
  materialClear:          '清空标注',
  answerInputLabel:       '申论作答输入区',
  answerAutosaveLabel:    '自动保存',
  gridResize:             '调整材料和答题分栏',
