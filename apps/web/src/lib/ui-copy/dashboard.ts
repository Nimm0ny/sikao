...
export const DASHBOARD_COPY = {
  ...
  retryHint:              '请稍后重试',
  mobileStartEyebrow:     '从这里开始',
  mobileStartEmpty:       '今天还没开始练习',
  mobileEditExamAria:     '编辑考试目标',
  mobileWeekOverviewAria: '本周练习概览',
  mobileTodayEmptyHint:   '配置学习习惯后会自动生成节奏',
  predictedUpdatedToast:  '目标已更新',
  predictedSaveFailedDesc:'检查输入或网络后重试',
  predictedRangeWarn:     '请输入 0–150 之间的整数',
  taskKindLabel: {
    practice: '行测练习',
    review_wrong: '错题复盘',
    essay_writing: '申论练习',
