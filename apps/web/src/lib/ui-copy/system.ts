...
export const AUTH_COPY = {
  ...
  login: {
    eyebrow: 'SIGN IN',
    title: '欢迎回来。',
    subtitleFallback: '继续你的备考节奏。',
    countdownSubtitle: (examLabel: string, daysUntil: number): string =>
      `距 ${examLabel}还有 ${daysUntil} 天。`,
    identifierLabel: '手机 / 邮箱 / 账号',
    passwordLabel: '密码',
    passwordPlaceholder: '输入密码',
    submit: '登录',
    submitting: '登录中…',
    missingFieldsWarn: '输入账号和密码',
    registerPrompt: '还没账号？',
  ...
  bindEmail: {
    sendEyebrow: 'PROFILE · EMAIL',
    confirmEyebrow: 'PROFILE · EMAIL',
    sendTitle: '绑定邮箱',
    ...
    emailLabel: '新邮箱',
    passwordLabel: '当前密码',
    emailInvalidWarn: '邮箱格式有误',
    passwordRequiredWarn: '输入密码',
  ...
  bindPhone: {
    eyebrow: 'PROFILE · PHONE',
    title: '绑定手机',
    subtitle: '中国大陆手机号，发码 10 分钟内有效',
    phoneLabel: '新手机号',
    codeLabel: '验证码',
    passwordLabel: '当前密码',
    phoneInvalidWarn: '手机号格式有误',
    codeInvalidWarn: '验证码为 6 位数字',
    passwordRequiredWarn: '输入密码',
    codePlaceholder: '6 位数字',
    codeHint: '发送后 60 秒内有效，未收到可重发。',
    passwordPlaceholder: '输入当前密码',
    submitButton: '确认绑定',
