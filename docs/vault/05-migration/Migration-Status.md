...
| Home Phase（2026-05-22 rebaseline） | partial | M0-M2 已完成；M3 后端 deliverables 已落地主干；M4 / SIK-35、M5 / SIK-36、M6 / SIK-37 已完成；backend-first 契约与 scheduler 链已收口；旧 Home 前端 runtime 轨继续作为 paused reference track |
