...
| Home Phase（2026-05-23 runtime closeout） | complete | M0-M2 已完成；M0.5 / SIK-31 已解锁前端 full typecheck blocker；M3 后端 deliverables 已落地主干；M4 / SIK-35、M5 / SIK-36、M6 / SIK-37 已完成；backend-first 契约与 scheduler 链已收口；M7 / SIK-38、M8 / SIK-39、M9 / SIK-40、M10 / SIK-41、M11 / route-shell convergence 与 M12 / a11y+browser acceptance 已在 `main` 上完成，`/profile/records`、canonical `"/"` Home、4-tab nav + RailMe 唯一入口、legacy redirect 收口已落地并通过验证；后续 Home calendar follow-up `SIK-138~SIK-142` 也已在 `main` 上收口，本地 plan/review ledger 已于 2026-05-30 对齐（本次未回写 Notion issue / Work Log） |
