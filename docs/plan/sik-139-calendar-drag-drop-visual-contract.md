...
| drop-target 高亮 | §4 focus-ring + info-soft | cell `data-drop-over` hook 已暴露（视觉高亮待 Wave 2） | 待 Wave 2 |
...
| 1440 / 1920 双开 diff | 交互三态截图 | W1 dragging/drop-move/click-peek 三态归档 `.tmp_review/out/sik-139-w1/` | PASS (W1) |
