...
| dragging chip 态 | §4 `--shadow-l2` 抬升 | — | 待 Wave 1 |
| drop-target 高亮 | §4 focus-ring + info-soft | — | 待 Wave 2 |
| keyboard-move 预览 | §4 focus-ring 实线 | — | 待 Wave 4 |
| 冲突确认层 | §4 peek-scrim + shadow-l4 | — | 待 Wave 3 |
| aria-live 落点播报 | §2 polite | — | 待 Wave 4 |
| 1440 / 1920 双开 diff | 交互三态截图 | — | 待 Wave 1-4 |

## 8. Closeout

- Wave 0（本提交）：静态不回归 + 锚点 + optimistic 通道三项 PASS，无可见像素变化，
