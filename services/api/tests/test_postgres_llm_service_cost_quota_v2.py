...
def test_postgres_home_llm_service_cost_quota_is_global_across_purposes(tmp_path: Path) -> None:
    with build_postgres_engine("sikao_llm_practice_cost") as engine:
        ...
        settings.llm_quota_per_user_cost_cny_per_day = 0.0015
        with session_factory() as session:
            user = seed_user(session, name="Cost Quota User")
            ...
            assert excinfo.value.code == "llm_daily_cost_quota_exceeded"
