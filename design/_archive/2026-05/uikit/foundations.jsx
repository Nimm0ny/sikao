      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginTop: 36 }}>
        <div className="uk-card">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 18, padding: '32px 0' }}>
            <div style={{ width: 84, height: 84, borderRadius: 20, background: 'var(--brand)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: 40, fontWeight: 800, boxShadow: '0 12px 30px -10px rgba(11,17,32,.4)' }}>思</div>
            <div>
...
window.VoiceTone = function VoiceTone() {
  ...
  return (
    <div style={{ width: 1280, height: 760, background: 'var(--bg)', padding: 56, fontFamily: 'var(--sans)', color: 'var(--ink)', overflow: 'auto' }}>
...
window.ColorBrand = function ColorBrand() {
  return (
    <div style={{ width: 1280, height: 680, background: 'var(--bg)', padding: 56, fontFamily: 'var(--sans)', color: 'var(--ink)' }}>
      ...
      <h1 className="doc-h" style={{ marginTop: 8 }}>黑色为主，<em>蓝是 accent</em></h1>
      <p className="doc-lead">Brand 是 ink — 标题、主按钮、Logo、当前态都是它。蓝降级为 accent，只在 focus / 链接 / 单一关键 CTA 上点缀。</p>

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 12, marginTop: 32 }}>
        <Sw bg="#f1f5f9" fg="#0b1120" name="brand-50" hex="#F1F5F9" vars="--brand-50"/>
        <Sw bg="#e2e8f0" fg="#0b1120" name="brand-100" hex="#E2E8F0" vars="--brand-100"/>
        <Sw bg="#cbd5e1" fg="#0b1120" name="brand-200" hex="#CBD5E1" vars="--brand-200"/>
        <Sw bg="#0b1120" name="brand · main" hex="#0B1120" vars="--brand"/>
        <Sw bg="#000000" name="brand-700" hex="#000000" vars="--brand-700"/>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginTop: 12 }}>
        <Sw bg="#eff6ff" fg="#1d4ed8" name="accent-50" hex="#EFF6FF" vars="--accent-50"/>
        <Sw bg="#3f7ef1" name="accent" hex="#3F7EF1" vars="--accent"/>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginTop: 24 }}>
        <div className="uk-card">
          <div className="label">使用比例 · 90/8/2</div>
          <div style={{ display: 'flex', height: 18, borderRadius: 6, overflow: 'hidden', marginTop: 12 }}>
            <div style={{ flex: 90, background: '#fff', borderRight: '1px solid var(--line)' }}/>
            <div style={{ flex: 8, background: 'var(--ink)' }}/>
            <div style={{ flex: 2, background: 'var(--accent)' }}/>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12, color: 'var(--muted)', marginTop: 8 }} className="mono">
            <span>90% 留白 + 灰阶</span><span>8% Ink</span><span>2% Accent</span>
          </div>
          <p style={{ fontSize: 13, color: 'var(--ink-muted)', marginTop: 14, lineHeight: 1.6 }}>
            一屏内 accent 蓝出现不超过 1-2 处。想用第 3 处蓝 — 八成是层级没分清，先试 ink 或灰阶。
          </p>
        </div>
        <div className="uk-card">
          <div className="label">分工</div>
          <div style={{ fontSize: 12, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.06em', fontWeight: 700, margin: '12px 0 6px' }}>BRAND · 黑 (ink)</div>
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 13, lineHeight: 1.85, color: 'var(--ink-muted)' }}>
            <li><span style={{ color: 'var(--success)', marginRight: 8, fontWeight: 700 }}>✓</span>主 CTA · "开始练习"、"提交答案"</li>
            <li><span style={{ color: 'var(--success)', marginRight: 8, fontWeight: 700 }}>✓</span>选中状态、tab active 下划线、Logo</li>
            <li><span style={{ color: 'var(--success)', marginRight: 8, fontWeight: 700 }}>✓</span>标题、强调数字、当前题号</li>
          </ul>
          <div style={{ fontSize: 12, color: 'var(--muted)', textTransform: 'uppercase', letterSpacing: '0.06em', fontWeight: 700, margin: '16px 0 6px' }}>ACCENT · 蓝</div>
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: 13, lineHeight: 1.85, color: 'var(--ink-muted)' }}>
            <li><span style={{ color: 'var(--success)', marginRight: 8, fontWeight: 700 }}>✓</span>focus ring、超链接、AI 建议 chip</li>
            <li><span style={{ color: 'var(--success)', marginRight: 8, fontWeight: 700 }}>✓</span>深色面板上的点缀 chip / progress（hero、sidebar）</li>
            <li><span style={{ color: 'var(--danger)', marginRight: 8, fontWeight: 700 }}>✗</span>大块装饰背景、正确/错误反馈（用语义色）</li>
          </ul>
        </div>
      </div>
    </div>
...
window.ColorNeutral = function ColorNeutral() {
  ...
  return (
    <div style={{ width: 1280, height: 620, background: 'var(--bg)', padding: 56, fontFamily: 'var(--sans)', color: 'var(--ink)' }}>
    ...
    <div style={{ width: 1280, height: 680, background: 'var(--bg)', padding: 56, fontFamily: 'var(--sans)', color: 'var(--ink)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginTop: 32 }}>
        {[
          ...
          { n: 'info / accent', main: '#3f7ef1', bg: '#eff6ff', label: 'ⓘ 提示', use: '提示、AI 建议、链接、focus' },
        ].map(s => (
...
window.TypeStack = function TypeStack() {
  return (
    <div style={{ width: 1280, height: 580, background: 'var(--bg)', padding: 56, fontFamily: 'var(--sans)', color: 'var(--ink)' }}>
...
window.TypeScale = function TypeScale() {
  ...
  return (
    <div style={{ width: 1280, height: 820, background: 'var(--bg)', padding: 56, fontFamily: 'var(--sans)', color: 'var(--ink)', overflow: 'auto' }}>
...
window.Radii = function Radii() {
  ...
  return (
    <div style={{ width: 1280, height: 500, background: 'var(--bg)', padding: 56, fontFamily: 'var(--sans)', color: 'var(--ink)' }}>
