...
const ExtraShell = ({ active, children }) => (
  <div style={{ width: 1280, minHeight: 800, display: 'flex', background: 'var(--bg-alt)', fontFamily: 'var(--sans)', color: 'var(--ink)' }}>
    ...
    {window.Sidebar ? <window.Sidebar active={active}/> : <div style={{ width: 220, background: 'var(--bg)', borderRight: '1px solid var(--line)' }}/>}
...
window.WrongB = function WrongB() {
  return (
    <div style={{ width: 1280, height: 800, background: 'var(--bg-alt)', fontFamily: 'var(--sans)', color: 'var(--ink)', position: 'relative' }}>
      <header style={{ height: 60, padding: '0 28px', borderBottom: '1px solid var(--line)', background: 'var(--bg)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      {/* 进度 */}
      <div style={{ padding: '14px 32px', background: 'var(--bg)', borderBottom: '1px solid var(--line)' }}>
...
window.BoldDiary = function BoldDiary() {
  return (
    <div style={{ width: 1280, height: 800, background: '#f5f1e8', fontFamily: 'var(--sans)', color: 'var(--ink)', padding: 40, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', height: '100%', background: 'var(--bg)', boxShadow: '0 20px 60px rgba(15,23,42,.12)', borderRadius: 8, display: 'flex', overflow: 'hidden' }}>
        {/* 左页 - 题目摘录 */}
...
window.MobileHome = function MobileHome() {
  return (
    <div style={{ width: 390, height: 844, background: 'var(--bg-alt)', fontFamily: 'var(--sans)', color: 'var(--ink)', position: 'relative', overflow: 'hidden' }}>
      ...
      {/* tabbar */}
      <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 80, background: 'var(--bg)', borderTop: '1px solid var(--line)', display: 'flex', justifyContent: 'space-around', paddingTop: 10 }}>
        {[
...
window.MobileSession = function MobileSession() {
  return (
    <div style={{ width: 390, height: 844, background: 'var(--bg)', fontFamily: 'var(--sans)', color: 'var(--ink)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ padding: 14, borderTop: '1px solid var(--line)', display: 'flex', gap: 8, background: 'var(--bg)' }}>
