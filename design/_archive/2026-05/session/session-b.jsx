  ...
  return (
    <div className="session-canvas" style={{ width: '100%', height: '100%', background: 'var(--bg-alt)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', overflow: 'hidden' }}>
        {/* 左 · 材料 */}
        <div style={{ borderRight: '1px solid var(--line)', background: 'var(--bg)', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '12px 24px', borderTop: '1px solid var(--line)', display: 'flex', gap: 10, background: 'var(--bg)' }}>
