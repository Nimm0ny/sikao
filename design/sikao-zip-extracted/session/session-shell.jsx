...
function ProgressStrip({ total, current, answered }) {
  return (
    <div style={{ display: 'flex', gap: 3, height: 4, padding: '0 24px', background: 'var(--paper)' }}>
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: 12, borderTop: '1px solid var(--line)', background: 'var(--paper)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '8px 10px', border: '1px solid var(--line-strong)', borderRadius: 10, background: 'var(--paper)' }}>
